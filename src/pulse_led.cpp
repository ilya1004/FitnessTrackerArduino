...
// int Threshold = 513; // Determine which Signal to "count as a beat", and which to ingore (включая)
// int TopBound = 518;  // Верхняя граница (включая)
...
//         if (Threshold <= Signal_value && Signal_value <= TopBound)
//         {
